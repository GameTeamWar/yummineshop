...
export default function LoginPage() {
  ...
  const type = searchParams.get('type'); // 'customer', 'partner', or 'courier'

  // Sadece customer, partner ve courier type'larına izin ver
    ...
    return (
      <div className="min-h-screen flex items-stretch bg-gray-100 dark:bg-gray-900 transition-colors duration-300" suppressHydrationWarning>
        ...
        <div className="hidden md:flex flex-col justify-center items-center w-1/2 bg-gray-900" suppressHydrationWarning>
          ...
          <div className="mt-8 text-center">
            <h2 className="text-2xl font-bold text-white mb-2">Yummine Partner Girişi</h2>
            <p className="text-gray-300 mb-6">Panelinize erişmek için giriş yapın</p>
            <div className="group relative">
              <button
                type="button"
                className="cursor-pointer"
              >
                <BsShop className="w-12 h-12 hover:scale-125 duration-200 hover:text-green-500 mx-auto" />
              </button>
              <span className="absolute -top-6 left-1/2 -translate-y-1/2 z-20 origin-left scale-0 px-3 rounded-lg border py-2 text-sm font-bold shadow-md transition-all duration-300 ease-in-out group-hover:scale-100 border-green-400 bg-green-500 text-white">
                Mağaza
              </span>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-center w-full md:w-1/2 px-6 py-12 bg-white text-gray-900 transition-colors duration-300">
          <div className="max-w-lg w-full mx-auto">
            ...
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Partner Girişi</h1>
              <p className="text-gray-600">Hesabınıza giriş yaparak panelinize erişin.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center">
                <Link href="/auth/forgot-password?type=partner" className="text-blue-600 hover:text-blue-800 text-sm">
                  Şifremi unuttum
                </Link>
              </div>
  ...
  if (type === 'courier') {
    return (
      <div className="min-h-screen flex items-stretch bg-gray-100 dark:bg-gray-900 transition-colors duration-300" suppressHydrationWarning>
        {/* Sol: SVG ve tanıtım */}
        <div className="hidden md:flex flex-col justify-center items-center w-1/2 bg-gray-900" suppressHydrationWarning>
          <img src="/graphic2.svg" alt="Kurye Giriş Görseli" className="w-3/4 max-w-lg mx-auto" />
          <div className="mt-8 text-center">
            ...
            <div className="group relative">
              <button
                ...
                className="cursor-pointer"
              >
                <FaMotorcycle className="w-12 h-12 hover:scale-125 duration-200 hover:text-blue-500 mx-auto" />
              </button>
              <span className="absolute -top-6 left-1/2 -translate-y-1/2 z-20 origin-left scale-0 px-3 rounded-lg border py-2 text-sm font-bold shadow-md transition-all duration-300 ease-in-out group-hover:scale-100 border-blue-400 bg-blue-500 text-white">
                Kurye
              </span>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-center w-full md:w-1/2 px-6 py-12 bg-white text-gray-900 transition-colors duration-300">
          <div className="max-w-lg w-full mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center">
                <Link href="/auth/forgot-password?type=courier" className="text-blue-600 hover:text-blue-800 text-sm">
                  Şifremi unuttum
                </Link>
              </div>
              ...
              <div className="text-center">
                <span className="text-gray-500">Hesabınız yok mu? </span>
                <Link href="/auth/register?type=courier" className="text-blue-600 hover:text-blue-800">
                  Kayıt olun
                </Link>
              </div>
            </form>
