...
const DeliveryFormSection: React.FC<DeliveryFormSectionProps> = ({ darkMode, user, initialShowForm = false }) => {
  ...
  return (
    <div className={`rounded-2xl p-4 sm:p-6 overflow-y-auto transition-colors duration-300 ${darkMode ? 'bg-gray-800 border border-neutral-700' : 'bg-white border border-neutral-200'} shadow-lg lg:block hidden`}>
      {!showForm ? (
