...
const CourierLayout: React.FC<CourierLayoutProps> = ({ children }) => {
  const courierSidebarContent = (
  ...
  return (
    <Layout sidebarContent={courierSidebarContent} showSidebar={true}>
      {children}
    </Layout>
  );
};
